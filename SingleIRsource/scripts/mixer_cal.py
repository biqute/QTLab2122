...
with FSWSynt("COM7") as synt:
    ...
    #synt.turn_on()
    print('The current frequency of the first synthetizer is: ' + str(synt.get_freq()))    #just to check if the freqency has been set correctly
...
with FSWSynt("COM12") as synt:
    ...
    time.sleep(0.005) #IMPORTANT for real time communication
    #synt.turn_on()
    print('The current frequency of the second synthetizer is: ' + str(synt.get_freq()))    #just to check if the freqency has been set correctly
