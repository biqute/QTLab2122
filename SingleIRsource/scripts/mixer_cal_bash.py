...
parser.add_argument('frequency', type=float, nargs='?', default=5.345679)
parser.add_argument('power',     type=float, nargs='?', default=20)
...
########## CONFIG PARAMETERS
freq        = args.frequency #5.345679 #5.345679 #5.380116 #5.638565 #5.869609 #max 6 decimals 
power       = args.power
#name       = get_date(file_name = 'mix_cal_' + str(int(freq * 1e6)))
name        = 'mix_cal_' +str(int(power)) + '_'+ str(int(freq * 1e6))
