...
waveforms         = [np.ndarray(total_samples, dtype=np.float64) for c in channels]  #prepare an empty array in which the waveform will be stored
...
logger.debug('Total samples: '       + str(total_samples))
