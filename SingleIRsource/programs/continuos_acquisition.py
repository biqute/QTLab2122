...
total_acq_time    = 10            #total acquisition time in seconds
...
with PXIeSignalAcq("PXI1Slot2", records=records, channels=channels, sample_rate=sample_rate, length=1, ref_pos=0.0) as daq:
